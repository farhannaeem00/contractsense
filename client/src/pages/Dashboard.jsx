...
import {
  ...
  Clock, AlertTriangle, CheckCircle, AlertCircle, LogOut
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            to="/upload"
            className="flex items-center gap-2 bg-indigo-600 text-white px-5 py-2.5 rounded-xl hover:bg-indigo-700 transition font-medium text-sm shadow-sm"
          >
          ...
          <div className="flex flex-col gap-3">
            {contracts.map(contract => (
              <div
                ...
                className={`bg-white rounded-2xl border border-gray-100 p-5 shadow-sm flex items-center justify-between gap-4
                  ${contract.status === 'done' ? 'hover:shadow-md hover:border-indigo-100 cursor-pointer' : 'cursor-default'}
                  transition`}
              >
                {/* Left — Icon + Info */}
                <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="font-semibold text-gray-800 truncate">{contract.fileName}</p>
